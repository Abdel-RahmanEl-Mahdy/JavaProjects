...
public class UpdateConflictWithExistingRow extends UITestCaseSwing {

	/**
	 * Create an Instance
	 */
	public UpdateConflictWithExistingRow() {
	 ...
	 * Main test method.
	 */
	public void testUpdateConflictWithExistingRow() throws Exception {
		IUIContext ui = getUI();
		...
		ui.click(new JTableItemLocator(new Point(6, 0)));
